  ...
  return (
    <div>
      ...
      >
        ...
        <div
          className={clsx(
            "hover:bg-default-200 translate w-28 h-32 flex items-center justify-center rounded-md overflow-hidden cursor-pointer",
            isInvalid ? "ring-2 ring-red-500" : "bg-default-100"
          )}
        >
          {src ? (
