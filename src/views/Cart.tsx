...
const Cart: FC<Props> = () => {
  ...
  if(!totalCount) return <div className="lg:p-0 p">
          <h1 className="text-xl mb-6 font-semibold">Your Shopping Cart</h1>
          <div className="p-5 text-center">
          <h1 className="font-semibold text-3xl opacity-40">This Cart is Empty</h1>
          </div>
  </div>
  return (
    <div className="lg:p-0 p">
          ...
          return (
            <div key={product.id} className="flex">
              ...
              <img
                src={product.cover}
                alt={product.title}
                className="w-28 h-[185] object-cover rounded"
              />
              {/* product detail */}
