        ...
        return (
          <div key={order.id}>
              ...
              return (
                ...
                <div className="flex p-5">
                  ...
                  <div className="px-5">
                    ...
                    <Chip color="danger" radius="sm" className="mt-2">{formatPrice(Number(product.totalPrice))} </Chip>
                  </div>
                </div>
            ...
            <div className="text-right space-y-1 py-6">
                <p className="font-semibold text-xl">Total Amount: {formatPrice(Number(order.totalAmount))}</p>
